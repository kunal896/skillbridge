...
# ---- LLM ----
# LLM_PROVIDER selects which backend agents/llm_client.py calls:
#   "groq"      -> free tier, no credit card, fast open models (default)
#   "gemini"    -> Google AI Studio free tier, no credit card
#   "anthropic" -> paid (small trial credit only, no ongoing free tier)
